...
public class Photo_2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_photo_2, container, false);
    ...
    private void save_data() {
        editor.putString(IMAGE_NAME_2, image_name);
        editor.putString(IMAGE_PATH_2, image_path);
        editor.apply();
    ...
    private void load_data(){
        image_path = sharedPreferences.getString(IMAGE_PATH_2, "");
