...
public class Photo_4 extends Fragment {
    ...
    public static  final String IMAGE_NAME_4 ="image_name_4";
    public static  final String IMAGE_PATH_4 ="fourth_patient_image";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_photo_4, container, false);
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                fr.replace(R.id.fragment_container, new Photo_3());
                fr.commit();
            }
        });
    ...
    private void save_data() {
        editor.putString(IMAGE_NAME_4, image_name);
        editor.putString(IMAGE_PATH_4, image_path);
        editor.apply();
    ...
    private void load_data(){
        image_path = sharedPreferences.getString(IMAGE_PATH_4, "");
