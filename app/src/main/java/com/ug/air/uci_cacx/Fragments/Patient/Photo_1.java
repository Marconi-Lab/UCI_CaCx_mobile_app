...
public class Photo_1 extends Fragment {
    ...
    public static  final String IMAGE_NAME ="image_name_1";
    public static  final String IMAGE_PATH ="first_patient_image";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_photo_1, container, false);
    ...
    private void save_data() {
        editor.putString(IMAGE_NAME, image_name);
    ...
    private void load_data(){
        image_path = sharedPreferences.getString(IMAGE_PATH, "");
